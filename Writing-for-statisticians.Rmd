...
+ You probably spend most of the time developing the technical aspect of this section. But you effort and word count is likely not proportional. 
...
+ The section(s) need to be self-contained with clear notations established, assumptions stated, and model choice justified. Do not assume your reader thinks the same way as you and uses the same notations by default. 
...
A paper needs to have a story arc:  There should be a problem, potentially some unsuccessful solutions, and a solution that you can recommend (potentially with caveats).
...
- If a word does not convey a precise meaning, it will be misinterpreted or your audience won't trust you. E.g., "worked quite well' or 'had X% better accuracy than', 'did not work' or 'failed to converge'.
